...
const Progress=()=>{
  ...
  <li>
    ...
    <div class="ml-4 mt-2 pb-5 md:ml-0">
      <h4 class="mb-1.5 text-xl font-semibold">First Launch</h4>
  ...
  <li>
    ...
    <div class="ml-4 mt-2 pb-5 md:ml-0">
      <h4 class="mb-1.5 text-xl font-semibold">Second Launch</h4>
      <p class="mb-3 text-neutral-500 dark:text-neutral-300">
  ...
  <li>
    ...
    <div class="ml-4 mt-2 pb-5 md:ml-0">
      <h4 class="mb-1.5 text-xl font-semibold">Third Launch</h4>
      <p class="mb-3 text-neutral-500 dark:text-neutral-300">
